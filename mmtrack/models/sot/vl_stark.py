...
class VLStark(BaseSingleObjectTracker):
    ...
    def __init__(self,
        ...
        super(VLStark, self).__init__(data_preprocessor, init_cfg)
        ...
        self.text_dim_mapper = torch.nn.Linear(self.text_encoder.width, self.head.embed_dims)
    ...
    def loss(self, inputs: dict, data_samples: List[TrackDataSample],
        ...
        nlp_text = [ds.nlp for ds in data_samples]
        tokenized_text = tokenize(self.tokenizer, nlp_text).to(search_img.device)
