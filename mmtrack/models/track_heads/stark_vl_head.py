...
class VLStarkTransformer(Transformer):
    ...
    def forward(self, x: Tensor, mask: Tensor, query_embed: Tensor,
        ...
        query_embed = torch.cat([query_embed, text_embed], dim=0)
...
class VLStarkHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 frozen_modules=None,
                 **kwargs):
        super(VLStarkHead, self).__init__(init_cfg=init_cfg)
    ...
    def loss_by_feat(self, pred_logits: Tensor, pred_bboxes: Tensor,
        ...
        if self.cls_head is None:
            ...
            gt_bboxes = gt_bboxes.repeat_interleave(2, dim=0)
